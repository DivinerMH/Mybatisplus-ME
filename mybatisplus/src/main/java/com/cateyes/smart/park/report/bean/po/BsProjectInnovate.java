...
/**
 * 智慧大屏-系统-技改投资类项目报表(SpBsProjectInnovate)Po
 *
 * @author CatEyes
 * @since 2023-06-29 10:52:12
 */
@Data
@Builder
...
@AllArgsConstructor
@NoArgsConstructor
@TableName("sp_bs_project_innovate")
public class BsProjectInnovate implements Serializable {
