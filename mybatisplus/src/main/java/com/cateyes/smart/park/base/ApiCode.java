package com.cateyes.smart.park.base;
...
public enum ApiCode {
    ...
    // smart-park-iot（190001 ~ 199999）
    DEVICE_REGION_PARENT_NOT_EXIST(190001, "父级区域不存在"), DEVICE_REGION_POSITION_CANNOT_HAVE_SUB(190002, "位置不能存在下级"),;
