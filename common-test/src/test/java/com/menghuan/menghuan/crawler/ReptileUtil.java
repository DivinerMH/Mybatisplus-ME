package java.com.menghuan.menghuan.crawler;
...
public class ReptileUtil {
    ...
    static String geturl = "http://192.168.1.163:8010/model/configuration/handleMap";
    static String filepath = "C:\\Users\\Administrator\\Desktop";
    ...
    /**
     * 下载图片 -- 通过获取的流转成byte[]数组，再通过FileOutputStream写出
