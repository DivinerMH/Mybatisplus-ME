package java.com.menghuan.menghuan.quickMark;
...
/**
 * 工具类
 *          1、编码和解码方法都有多个重载方法，根据参数列表的不同，选择不同的方法执行；
 *          2、其中生成的二维码的图片的名字可以随机命名，也可以自己给定。我把随机命名的方法注释了，用的是给定图片名称。
 * @Author: menghuan
...
public class QRCodeUtil {
    ...
    private static BufferedImage createImage(String content, String imgPath, boolean needCompress) throws Exception {
        ...
        // 优化精度
        // hints.put(EncodeHintType., Boolean.TRUE);
        // 设置图片边距
