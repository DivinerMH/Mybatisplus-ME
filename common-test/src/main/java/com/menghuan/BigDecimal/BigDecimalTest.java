...
/**
 * 参考： https://blog.csdn.net/wjw_de_java/article/details/110096491
 * 
 * @Author: menghuan
...
public class BigDecimalTest {
    ...
    @Test
    public void valueOf() {
        BigDecimal bigDecimal_1 = new BigDecimal(10000);
        System.out.println(bigDecimal_1);

        BigDecimal bigDecimal_2 = BigDecimal.valueOf(20000);
        System.out.println(bigDecimal_2);
    }
