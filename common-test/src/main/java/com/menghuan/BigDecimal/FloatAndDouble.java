...
public class FloatAndDouble {
    ...
    /**
     * BigDecimal(double val) 精度丢失问题 BigDecimal(String val) 推荐 ( 所以，一定要使用String的构造方法 )
     */
    ...
    private static void test3() {
        ...
        BigDecimal tradeAmount =
            new BigDecimal(String.valueOf(totalAmount)).subtract(new BigDecimal(String.valueOf(feeAmount)));
        System.out.println(tradeAmount);
    }
