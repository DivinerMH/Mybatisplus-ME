...
public class MeGenerator {
    ...
    // 全局配置
    private final static String OUTPUT_DIR = "/mybatisplus/src/main/java";      // 生成文件的输出目录(项目中放置位置)
    private final static String AUTHOR = "menghuan";                            // 开发人员信息
    // 数据源配置
    ...
    private final static String DATABASE_NAME = "iot_asset";                  // 数据库名称
    // 包配置
    private final static String PARENT = "com.hzcloud.iot.asset";                 // 父包名。 如果为空，将下面子包名必须写全部， 否则就只需写子包名
    private final static String MODULE_NAME = "structure";                        // 父包模块名 , 可以为空字符串
