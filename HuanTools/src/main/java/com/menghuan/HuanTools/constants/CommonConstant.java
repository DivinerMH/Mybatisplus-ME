...
public interface CommonConstant {
     ...
     * 供应商出库状态
     */
    String GROUP_CODE_PURCHASE = "purchase_status";
    String[] PURCHASE_STATUS_1 = {"10", "50", "60"};
    /**
     * 供应商黑名单状态
     */
    String[] PURCHASE_STATUS_2 = {"40"};
    /**
     * 供应商加入黑名单审批状态
     */
    String[] PURCHASE_STATUS_3 = {"10", "20", "40"};
    /**
     * 供应商移出黑名单审批状态
     */
    String[] PURCHASE_STATUS_4 = {"10", "30", "40"};
    ...
    /** =============================================================================================== */
    /**
     * ::非常重要:: 注意：这四个常量值如果修改，需要与 jeecg-boot-starter/jeecg-boot-common/org.jeecg.config.FeignConfig 类中的值保持一致。
     */
     ...
     * 供应商入库新增账号默认密码
     */
    String USER_NEW_PURCHASE_PASSWORD = "Dfzl@8888";

    /**
     * 供应商默认部门id
     */
    String USER_NEW_PURCHASE_DEPART = "gys001";

    /**
     * 供应商默认角色id
     */
    String USER_NEW_PURCHASE_ROLE = "gys001";

    /**
     * 供应商默认门店id
     */
    String USER_NEW_PURCHASE_STORES = "gys001";
