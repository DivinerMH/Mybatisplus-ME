...
public class CustConvertUtils {
    ...
    /*public static String readStatic(String url) {
    	...
    	try {
    		...
    		InputStream stream = CustConvertUtils.class.getClassLoader().getResourceAsStream(url.replace("classpath:", ""));
     ...
     * @return
     */
    // public static List<FieldDTO> getDynamicFields(Object object) {
    // if(object==null){
    // return null;
    // }
    ...
    // FieldDTO fieldDTO = new FieldDTO(annotation.fileName(), field.getName(), o,annotation.valueType(),
    // annotation.order(), annotation.type());
    // if(annotation.type()==2){
    // List<HeadInfoDTO> headInfoDTOS=new ArrayList<>();
    // Object list = field.get(object);
    // if(o!=null && list instanceof List<?>){
    // List<Object> objectList=(List<Object>) list;
    // for (Field field1 : getAllFields(objectList.get(0))){
    // //增加表头
    // FieldValue annotation1 = field1.getAnnotation(FieldValue.class);
    // if(annotation1!=null){
    // headInfoDTOS.add(new
    // HeadInfoDTO(annotation1.order(),annotation1.fileName(),field1.getName(),annotation1.valueType()));
    // }
    // }
    // headInfoDTOS.sort(Comparator.comparingInt(HeadInfoDTO::getOrder));
    // fieldDTO.setHeaderInfo(headInfoDTOS);
    // }
    // }
    // fields.add(fieldDTO);
    // } catch (IllegalAccessException e) {
    ...
    // }
    // }
    // fields.sort(Comparator.comparingInt(FieldDTO::getOrder));
    // return fields;
    // }
}
