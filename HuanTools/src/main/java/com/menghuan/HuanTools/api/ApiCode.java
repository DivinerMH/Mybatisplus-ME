...
public enum ApiCode {
    ...
    USER_NAME_ALREADY_EXISTS(110008, "账户名称已存在"), USER_OLD_PASSWORD_ERROR(110009, "原密码错误"),
    USER_NOT_ASSIGNED_ROLE(1100010, "账户未分配角色"), ROLE_NOT_EXISTS(110007, "角色不存在"),
    ACCESS_TOKEN_INVALID(110110, "Access-Token 无效"), App_NAME_ALREADY_EXISTS(1100010, "应用名称已存在"),
    MENU_NOT_EXISTS(1100011, "菜单不存在"), MENU_NAME_ALREADY_EXISTS(1100010, "菜单名称已存在"),
    MENU_CODE_ALREADY_EXISTS(1100011, "菜单编码已存在"), MENU_CONTAINS_SUBMENUS(1100002, "菜单下含有子菜单,无法删除"),
    STRUCT_NAME_ALREADY_EXISTS(1100011, "组织名称已存在"), STRUCT_NOT_EXISTS(1100011, "组织不存在"),
    BUCKET_NOT_EXISTS(1200001, "bucket不存在"), SYSTEM_INNER_DATA_CAN_NOT_BE_OPERATED(1100012, "系统内置数据,禁止操作"),
    ...
    ENTERPRISE_STAR_NOT_EXISTS(150201, "明星企业不存在"), GOV_LEADER_NOT_EXISTS(150301, "领导分工不存在"),
    ARTICLE_NOT_EXISTS(150401, "文章不存在"), ARTICLE_PUBLISH_STATUS_ERROR(150402, "文章发布状态异常"),
    GOV_PROFILE_NOT_EXISTS(150501, "机构简介不存在"), PORTAL_USER_NOT_EXISTS(150601, "用户不存在"),
    PORTAL_USER_PWD_ERROR(150602, "密码错误"), PORTAL_USER_ERROR(150603, "用户信息异常"),
    ...
    PARK_THROUGH_ITEM_STATUS_NOT_ALLOWED(150906, "当前状态不支持此操作"), PROPERTY_SERVICE_NOT_EXISTS(151001, "物业服务事件不存在"),
    PROPERTY_SERVICE_ITEM_STATUS_CHANGED(151002, "物业服务事件状态已变更"), PROPERTY_SERVICE_ITEM_FINISHED(151003, "物业服务事件已处理"),
