...
/**
 * 企业亩均效益指标设置(SpEnterpriseMuBenefitTarget)service
 *
 * @author CatEyes
 * @since 2023-07-21 15:43:29
 */

public interface IEnterpriseMuBenefitTargetService
    extends SpBaseService<RspEnterpriseMuBenefitTargetDto, ReqEnterpriseMuBenefitTargetDto> {
