...
/**
 * 产业链节点评价指标设置(SpInIndustryWeak)service
 *
 * @author CatEyes
 * @since 2023-07-17 11:00:36
 */

public interface IIndustryWeakService extends SpBaseService<RspIndustryWeakDto, ReqIndustryWeakDto> {
