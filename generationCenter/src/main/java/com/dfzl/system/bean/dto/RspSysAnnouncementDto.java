...
import org.jeecg.common.system.dto.RspBaseDto;
...
/**
 * 系统通告表(SysAnnouncement)RspDto
 *
 * @author menghuan
 * @since 2025-09-11 15:01:55
 */
@Data
@ApiModel(value = "系统通告表RspDto")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class RspSysAnnouncementDto extends RspBaseDto {
